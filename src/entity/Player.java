...
//		right2 = setup("sampingkananjalan");	
		up1 = setup("/player/depankiri");
		up2 = setup("/player/depankanan");
		down1 = setup("/player/depankiri");
		down2 = setup("/player/depankanan");
		left1 = setup("/player/sampingkiri");
		left2 = setup("/player/sampingkirijalan");
		right1 = setup("/player/sampingkanan");
		right2 = setup("/player/sampingkananjalan");	
	}
...
//				keyL.leftPressed == true || keyL.rightPressed == true || keyL.enterPressed == true) {
		if(keyL.upPressed == true || keyL.downPressed == true || keyL.leftPressed == true 
				|| keyL.rightPressed == true) {	
